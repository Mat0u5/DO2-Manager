...
public class CrossbowEvents {
    ...
    public static final Identifier GUNSHOT_ID = Identifier.fromNamespaceAndPath("minecraft", "do2.weapon.gunshot");
    public static final SoundEvent GUNSHOT = SoundEvent.createVariableRangeEvent(GUNSHOT_ID);
    public static final Identifier GUNLOAD_ID = Identifier.fromNamespaceAndPath("minecraft", "do2.weapon.gun_loading");
    public static final SoundEvent GUNLOAD = SoundEvent.createVariableRangeEvent(GUNLOAD_ID);
    public static final Identifier GUNLOAD_FINISH_ID = Identifier.fromNamespaceAndPath("minecraft", "do2.weapon.gun_load_fin");
    public static final SoundEvent GUNLOAD_FINISH = SoundEvent.createVariableRangeEvent(GUNLOAD_FINISH_ID);

    public static void onCrossbowUse(Level world, Player user, InteractionHand hand, CallbackInfoReturnable<InteractionResult> cir) {
