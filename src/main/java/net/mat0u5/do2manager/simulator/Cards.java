...
public class Cards {
    ...
    public final Card BBSlippers = new Card("bb_slippers","2CB,custom",true,false,1);//done
    public final Card FrozenFrenzy = new Card("frozen_frenzy","20E",false,false,1);//done
    ...
    public Card[] allCards = {
            ...
            ,Zoltraak,StrideWithPride,DelvingGrace,BBSlippers,FrozenFrenzy
    };
